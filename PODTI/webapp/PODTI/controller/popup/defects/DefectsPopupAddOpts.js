sap.ui.define([
    ...
    return Dialog.extend("kpmg.custom.pod.PODTI.PODTI.controller.popup.defects.DefectsPopupAddOpts", {
        ...
        open: function (oView, oController, fromTabAdditionalOperations, selectedObject) {
            ...
            that._initDialog("kpmg.custom.pod.PODTI.PODTI.view.popup.defects.DefectsPopupAddOpts", oView, that.DefectsModel);
        ...
        onExpandAll: function () {
            const oTable = this.MainPODcontroller.byId("treeTableDefectPopupAddOpts");
